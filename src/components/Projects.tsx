...
const projects = [
  {
    ...
    stack: ['Ruby on Rails', 'GraphQL', 'Next.js', 'TypeScript', 'Docker', 'PostgreSQL'],
  ...
  },
  {
    ...
    stack: ['React Native', 'TypeScript', 'Node.js', 'Express', 'REST API'],
  ...
  },
  {
    ...
    stack: ['Swift', 'UIKit', 'AVFoundation', 'Coordinators', 'Unit Tests'],
  ...
  },
  {
    ...
    stack: ['Swift', 'UIKit', 'async/await', 'Coordinators', 'UserDefaults'],
  ...
  },
  {
    ...
    stack: ['SwiftUI', 'Core Data', 'AVFoundation', 'LazyVGrid'],
